...
import { DeleteOutlined, EditOutlined, WifiOutlined } from '@ant-design/icons';

const { Title } = Typography;

const AdminWifiData = ({ wifiData, openEditModal, handleDelete }) => {
  const columns = [
    {
      title: '№',
      dataIndex: 'id',
