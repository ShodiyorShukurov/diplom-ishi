...
import { DeleteOutlined, EditOutlined, CloudServerOutlined } from '@ant-design/icons';

const { Title } = Typography;

const AdminMemoriesData = ({ memoriesData, openEditModal, handleDelete }) => {
  const columns = [
    {
      title: '№',
      dataIndex: 'id',
...
export default AdminMemoriesData;
